...
function TitlePageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of TitlePageComponents)
...
function Instructions5pt5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instructions5pt5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Instructions14RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instructions14Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Instructions6pt2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instructions6pt2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PracticeTrial1_CueRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PracticeTrial1_CueComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practiceLoop2LoopBegin(practiceLoop2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeLoop2 of practiceLoop2) {
...
function practiceLoop3LoopBegin(practiceLoop3LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeLoop3 of practiceLoop3) {
...
function practiceLoop4LoopBegin(practiceLoop4LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeLoop4 of practiceLoop4) {
...
function practiceLoop5LoopBegin(practiceLoop5LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeLoop5 of practiceLoop5) {
...
function practiceLoop6LoopBegin(practiceLoop6LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeLoop6 of practiceLoop6) {
...
function practiceLoop7LoopBegin(practiceLoop7LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeLoop7 of practiceLoop7) {
...
function practiceLoop8LoopBegin(practiceLoop8LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeLoop8 of practiceLoop8) {
...
function PracticeTrial_StimRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PracticeTrial_StimComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PracticeTrial_FeedbackRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of PracticeTrial_FeedbackComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function InstructionsSpaceToContinueRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of InstructionsSpaceToContinueComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function PracticeTrial2_CueRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of PracticeTrial2_CueComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions11RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions11Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions9RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions9Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions21RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions21Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions24RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions24Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions25RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions25Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions15RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions15Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions32RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions32Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions27RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions27Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions33RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions33Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions26RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions26Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions34RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions34Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions28RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions28Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions29RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions29Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions22RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions22Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions30RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions30Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function Instructions36RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of Instructions36Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function PracticeTrial5_CueRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of PracticeTrial5_CueComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function PracticeTrial6_CueRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of PracticeTrial6_CueComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function PracticeTrial7_CueRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of PracticeTrial7_CueComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function PracticeTrial8_CueRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of PracticeTrial8_CueComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
